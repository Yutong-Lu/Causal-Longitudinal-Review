...
c_1 <- rbinom(ntot, 1, plogis(-1 + 0.02*w1 + 0.01*w2 - 0.4*L1_1 - 0.2*L2_1 - 0.5*a_1))
table(c) # around < 100

c_2 <-
# for v1 and v2, 50 ppl have at least one NA, 900 ppl have complete data
...
#Error in tapply(censor_p0_inv, obs_data[["id"]], FUN = cumprod) : 
