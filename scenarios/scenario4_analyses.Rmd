...
Analyzing simulated dataset for scenario 4
...
# Loading simulated dataset 4
```{r}
dat4 <- read_csv("datasets/scenario_4_wide_dataset.csv")
dat4_new <- read_csv("datasets/scenario_4_long_dataset.csv")
```
...
# we have two censors, c_1 and c_2
censor_name <- 'c'
...
summary(tmle_model, estimator="tmle")
# Ynodes may not be NA except after censoring
